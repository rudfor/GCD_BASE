...
HD_PWD='C:/Users/ruft/SCHOOL/GCD_BASE/GCD_BASE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gcd_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gcd_top.tcl
